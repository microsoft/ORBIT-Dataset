...
class UserEpisodicDatasetQueue(DatasetQueue):
    def __init__(self, root, way_method, object_cap, shot_method, shots, video_types, subsample_factor, clip_methods, clip_length, preload_clips, frame_size, annotations_to_load, tasks_per_user, test_mode, with_cluster_labels, with_caps, shuffle):
        DatasetQueue.__init__(self, tasks_per_user, shuffle, test_mode)
        self.dataset = UserEpisodicORBITDataset(root, way_method, object_cap, shot_method, shots, video_types, subsample_factor, clip_methods, clip_length, preload_clips, frame_size, annotations_to_load, test_mode, with_cluster_labels, with_caps)
        self.num_users = self.dataset.num_users

class ObjectEpisodicDatasetQueue(DatasetQueue):
    def __init__(self, root, way_method, object_cap, shot_method, shots, video_types, subsample_factor, clip_methods, clip_length, preload_clips, frame_size, annotations_to_load, tasks_per_user, test_mode, with_cluster_labels, with_caps, shuffle):
        DatasetQueue.__init__(self, tasks_per_user, shuffle, test_mode)
        self.dataset = ObjectEpisodicORBITDataset(root, way_method, object_cap, shot_method, shots, video_types, subsample_factor, clip_methods, clip_length, preload_clips, frame_size, annotations_to_load, test_mode, with_cluster_labels, with_caps)
        self.num_users = self.dataset.num_users
